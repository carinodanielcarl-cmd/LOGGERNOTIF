...
local UI_NAME = "AJGODZX_SCANNER_GUI"
if CoreGui:FindFirstChild(UI_NAME) then CoreGui[UI_NAME]:Destroy() end
if SoundService:FindFirstChild("AJGODZXScannerSound") then SoundService.AJGODZXScannerSound:Destroy() end
...
local T = {
    ...
    Accent1     = Color3.fromRGB(0, 255, 200), -- AJGODZX Cyan
    Accent2     = Color3.fromRGB(0, 200, 255),
    AccentGlow  = Color3.fromRGB(0, 150, 150),
...
-- AUTO SAVE CONFIG
-- ═══════════════════════════════════
local CONFIG_FILE = "AJGODZX_Scanner_Config.json"
...
task.spawn(function()
    ...
    while _G.AJGODZXScannerRunning ~= false do
        task.wait(3)
        pcall(function()
...
CloseBtn.MouseButton1Click:Connect(function()
    _G.AJGODZXScannerRunning = false
